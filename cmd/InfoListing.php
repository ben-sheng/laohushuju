...
for($i=0;$i<$subtasktotal;$i++){
    $shellcmd = "cd /data/panda;nohup /usr/local/php/bin/php think ebay --cmd listinginfo --country $country -t $tasktotal -s $tasksn ";
    $shellcmd .= " --subtasktotal $subtasktotal --subtasksn $i >>/data/panda/runtime/log/panda/listing_info.log 2>&1 &";
//    echo "\n$shellcmd";
